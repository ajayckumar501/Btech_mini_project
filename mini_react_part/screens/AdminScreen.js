...
const AdminScreen = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const apiresponse = await axios.get("http://192.168.92.163:8080/api/v1/admin/fetchDatavalues");
  ...
  const handleAddService = async () => {
    try {
      ...
      await axios.post("http://192.168.92.163:8080/api/v1/admin/addingnewservice", { serviceName: newServiceName });
