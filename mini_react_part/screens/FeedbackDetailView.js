        ...
        <View style={styles.maincontainer}>
            <View style={styles.scrollcontainer}>
                ...
                <View style={{ paddingHorizontal: 25, paddingTop:"10%" }}>
                    ...
                    <ScrollView style={styles.mainfeedbackbox}>
                        <Text style={{ fontSize: 20, fontWeight: "800", color: "#575757", marginTop: 15, marginBottom:0, marginLeft:"0%" }}>{displaygiver()} : </Text>
                        <Text style={{ fontSize: 16, fontWeight: "400", color: "#575757", marginTop: 0, marginBottom:500, marginLeft:"5%" }}>{displayfeedback()}</Text>
                    </ScrollView>
